...
public class GetUsersBelongToProjectRequest {
	@NotNull
	...
	public GetUsersBelongToProjectRequest(String adminSession, String projectId) 
	{
		this.adminSession = adminSession;
		this.projectId = projectId;
	}
	public GetUsersBelongToProjectRequest() {
	}	
